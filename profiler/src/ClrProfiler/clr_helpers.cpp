...
namespace trace
{
    ...
    mdAssemblyRef GetProfilerAssemblyRef(CComPtr<IUnknown>& metadata_interfaces) {
        ...
        assemblyMetaData.usMajorVersion = ProfilerAssemblyVersion.major;
        assemblyMetaData.usMinorVersion = ProfilerAssemblyVersion.minor;
        assemblyMetaData.usBuildNumber = ProfilerAssemblyVersion.build;
        assemblyMetaData.usRevisionNumber = ProfilerAssemblyVersion.revision;

        pAssemblyEmit->DefineAssemblyRef(
            (void *)ProfilerAssemblyNamePublicKey.data(),
            (ULONG)ProfilerAssemblyNamePublicKey.size(),
